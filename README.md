...
Used in:
mfx-ui-gcui, mfx-ui-itvstudios, mfx-ui-eone, mfx-ui-lgt, react-video-conference, mfx-ui-boilerplate
...
Extending minor-2 for Node 24 support.
New version must be maintained and released from branch `minor-3`

Major changes
- Removed node-sass in favor of dart-sass (`sass`)
- Added `postcss` and updated `autoprefixer` for PostCSS 8 compatibility
